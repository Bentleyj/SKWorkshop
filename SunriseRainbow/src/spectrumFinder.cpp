...
//--------------------------------------------------------------
bool compareHue(pair<ofColor, int> col1, pair<ofColor, int> col2) {
    return col1.first.getHue() < col2.first.getHue();
}

bool compareSat(pair<ofColor, int> col1, pair<ofColor, int> col2) {
    return col1.first.getSaturation() < col2.first.getSaturation();
}

bool compareVal(pair<ofColor, int> col1, pair<ofColor, int> col2) {
    return col1.first.getBrightness() < col2.first.getBrightness();
}
